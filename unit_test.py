...
class CircleTestCase(unittest.TestCase):
    ...
    def test_area(self):
        ...
        self.assertAlmostEqual(circle_area(-8), math.pi * -8 * -8, places=5) 
    ...
    def test_perimeter(self):
        ...
        self.assertAlmostEqual(circle_perimeter(-6), 2 * math.pi * -6, places=5)

#test for rectangle
class RectangleTestCase(unittest.TestCase):

    def test_area(self):
        self.assertEqual(rec_area(-5, -6), 30)
    ...
    def test_perimeter(self):
        self.assertEqual(rec_perimeter(-5 , -6), -22)
...
class SquareTestCase(unittest.TestCase):
    ...
    def test_perimeter(self):
        self.assertEqual(sq_perimeter(-5), -20)
